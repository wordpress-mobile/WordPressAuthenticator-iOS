Pod::Spec.new do |s|
  ...
  s.dependency 'WordPressKit', :git => 'https://github.com/wordpress-mobile/WordPressKit-iOS', :branch => 'upgrade/xcode-to-12.0' # Don't change this until we hit 5.0 in WPKit
